...
const Etiquette: FunctionComponent = () => {
    return <div id="mainContent">



        <p>
            <strong><b>Kendo Etiquette</b><br /></strong>
            <br />

            <b>The Concept of Kendo</b><br />
The concept of Kendo is to discipline the human character through the application of the principles of the
Katana.<br />
            <br />

            <b>The purpose of practicing Kendo is:</b><br />
...
And to promote peace and prosperity among all peoples.<br />
            ...
            <b>Kendo Safety Guidelines</b><br />
...
9. No rings, necklaces, earrings, br /acelets or other jewelry are permitted during practice, because they are very
...
basis, and every shinai must be inspected for cracks, splinters, tom or br /oken leather fittings, or other damage,
